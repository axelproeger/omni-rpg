...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        @component('components.breadcrumb')
            ...
            <li class="breadcrumb-item"><a
                    href="{{ url('/character/' . $character->slug) }}">{{ $character->full_name }}</a>
            </li>
    ...
    <form id="deleteCharacterAvatarForm" method="POST"
          action="{{ url('/characters/' . $character->slug . '/avatar/delete') }}">
        @csrf
    </form>

    <form id="updateCharacterAvatarForm" method="POST" action="{{ url('/characters/' . $character->slug . '/avatar') }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group row text-center">
                    <div class="col-sm-6">
                        ...
                        <img src="{{ $character->getAvatarPath() }}" class="img-fluid rounded character-avatar-large" stylealt="">
                    </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                @if ($character->hasAvatar())
                    <button type="submit" class="btn btn-danger" form="deleteCharacterAvatarForm">Aktuelles Bild löschen</button>
                @endif
            </div>
        </div>

...
@section('title') Charakter bearbeiten @endsection
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <li class="breadcrumb-item"><a
      href="{{ url('/character/' . $character->slug) }}">{{ $character->full_name }}</a></li>
  <li class="breadcrumb-item active" aria-current="page">Charakter bearbeiten</li>
  @endcomponent
...
<div class="card shadow mb-4">
  <div class="card-body">
    Auf dieser Seite kannst du die Charaktereigenschaften und Interessen des Charakters anpassen, sowie den Lebenslauf
    erweitern. Alle anderen Angaben können nur von der Personalabteilung verändert werden. Außerdem werden alle
    Änderungen und Anpassungen von der Personalabteilung gesichtet und freigeschaltet werden, bevor sie öffentlich
    einsehbar sind.
  </div>
</div>
